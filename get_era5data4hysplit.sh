...
# python call
# MDL="python"
pythoncall="/data/ggong/miniconda3/envs/ggong/bin/python"
...
if [ -n "$ERA_datadir" ]; then
  ...
  ERA_datadir='/data/ggong/reanalysis/ERA/ERA5_4hysplit'
fi
# echo ${ERA_datadir}
# exit
MDL='/data/shared_code/hysplit/data2arl/era52arl'
...
area="65/-130/15/25" # This cover the entire US
